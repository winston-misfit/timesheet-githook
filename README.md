...
- Steps
  ...
  3. Copy the git hook with this command `` wget --no-check-certificate https://github.com/winston-misfit/timesheet-githook/master/post-commit && chmod +x post-commit ``
