...
- Steps
  ...
  3. Copy the git hook with this command `` wget --no-check-certificate https://github.com/winston-misfit/timesheet-githook/blob/master/post-commit && chmod +x post-commit ``
